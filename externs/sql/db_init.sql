...
insert into functions (id, name) values (1, 'main:int(int,char**)');
insert into functions (id, name) values (2, 'add:int(int,int)'), (3, 'mul:int(int,int)');
insert into functions (id, name) values (4, 'grid:int(int, int, char**)');
